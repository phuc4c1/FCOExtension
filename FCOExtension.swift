...
extension UITextView {
    func getHeightWithWidthFixed() -> CGFloat {
        ...
        let boundingBox = self.text.boundingRect(with: constraintRect, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedStringKey.font: self.font ?? UIFont.systemFont(ofSize: 13)], context: nil)
